...
\begin{document}
  ...
  \begin{abstract}
    ...
    as standard cosmology at $t \lesssim t_\mathrm{Planck}$ --- implicitly
    assumes a non-injective projection.
    ...
    of an unspecified projection $\Pi$ invisible from the effective level
    alone.
  \end{abstract}
